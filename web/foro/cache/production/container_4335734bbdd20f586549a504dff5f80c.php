...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'phpbbseo.meta.core' => 'getPhpbbseo_Meta_CoreService',
            'phpbbseo.meta.listener' => 'getPhpbbseo_Meta_ListenerService',
            'phpbbseo.usu.core' => 'getPhpbbseo_Usu_CoreService',
            'phpbbseo.usu.listener' => 'getPhpbbseo_Usu_ListenerService',
            'plupload' => 'getPluploadService',
            'primehalo.primelinks.listener' => 'getPrimehalo_Primelinks_ListenerService',
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'foro3_oauth_tokens', 'foro3_oauth_states', 'foro3_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'foro3_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'foro3_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'foro3_config_text');
    }
    ...
    {
        return $this->services['console.command.extension.disable'] = new \phpbb\console\command\extension\disable($this->get('user'), $this->get('ext.manager'), $this->get('log'), 'phpbb\\cache\\driver\\file');
    }
    ...
    {
        return $this->services['console.command.extension.enable'] = new \phpbb\console\command\extension\enable($this->get('user'), $this->get('ext.manager'), $this->get('log'), 'phpbb\\cache\\driver\\file');
    }
    ...
    {
        return $this->services['console.command.extension.purge'] = new \phpbb\console\command\extension\purge($this->get('user'), $this->get('ext.manager'), $this->get('log'), 'phpbb\\cache\\driver\\file');
    }
    ...
    {
        return $this->services['console.command.extension.show'] = new \phpbb\console\command\extension\show($this->get('user'), $this->get('ext.manager'), $this->get('log'), 'phpbb\\cache\\driver\\file');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'foro3_forums', 'foro3_posts', 'foro3_topics', 'foro3_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('foro3_captcha_questions', 'foro3_captcha_answers', 'foro3_qa_confirm');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('phpbbseo.meta.listener', 'phpbbseo\\meta\\event\\listener');
        $instance->addSubscriberService('phpbbseo.usu.listener', 'phpbbseo\\usu\\event\\listener');
        $instance->addSubscriberService('primehalo.primelinks.listener', 'primehalo\\primelinks\\event\\main_listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'foro3_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'foro3_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'foro3_migrations', './', 'php', 'foro3_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'foro3_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'foro3_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'foro3_notification_types', 'foro3_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'foro3_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'foro3_notification_types', 'foro3_user_notifications');
    }
    ...
    /**
     * Gets the public 'phpbbseo.meta.core' shared service.
     *
     * @return \phpbbseo\meta\core
     */
    protected function getPhpbbseo_Meta_CoreService()
    {
        return $this->services['phpbbseo.meta.core'] = new \phpbbseo\meta\core($this->get('config'), $this->get('template'), $this->get('user'), $this->get('symfony_request'), './', 'php');
    }

    /**
     * Gets the public 'phpbbseo.meta.listener' shared service.
     *
     * @return \phpbbseo\meta\event\listener
     */
    protected function getPhpbbseo_Meta_ListenerService()
    {
        return $this->services['phpbbseo.meta.listener'] = new \phpbbseo\meta\event\listener($this->get('phpbbseo.meta.core'), $this->get('dbal.conn'), $this->get('phpbbseo.usu.core', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }

    /**
     * Gets the public 'phpbbseo.usu.core' shared service.
     *
     * @return \phpbbseo\usu\core
     */
    protected function getPhpbbseo_Usu_CoreService()
    {
        return $this->services['phpbbseo.usu.core'] = new \phpbbseo\usu\core($this->get('config'), $this->get('request'), $this->get('user'), $this->get('auth'), './', 'php');
    }

    /**
     * Gets the public 'phpbbseo.usu.listener' shared service.
     *
     * @return \phpbbseo\usu\event\listener
     */
    protected function getPhpbbseo_Usu_ListenerService()
    {
        return $this->services['phpbbseo.usu.listener'] = new \phpbbseo\usu\event\listener($this->get('phpbbseo.usu.core'), $this->get('config'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('request'), $this->get('dbal.conn'), $this->get('language'), './', 'php');
    }
    ...
    /**
     * Gets the public 'primehalo.primelinks.listener' shared service.
     *
     * @return \primehalo\primelinks\event\main_listener
     */
    protected function getPrimehalo_Primelinks_ListenerService()
    {
        return $this->services['primehalo.primelinks.listener'] = new \primehalo\primelinks\event\main_listener($this->get('template'), $this->get('user'), $this->get('config'));
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'foro3_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('dbal.tools'), $this->get('dispatcher'), $this->get('language'), $this->get('log'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'foro3_profile_fields', 'foro3_profile_fields_data', 'foro3_profile_fields_lang', 'foro3_profile_lang');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000716874ea000000007010d2a4(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'foro3_bbcodes', 'foro3_smilies', 'foro3_styles', 'foro3_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'foro3_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'foro3_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'foro3_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'foro3_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'foro3_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'foro3_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'foro3_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'foro3_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'foro3_acl_groups',
            'tables.acl_options' => 'foro3_acl_options',
            'tables.acl_roles' => 'foro3_acl_roles',
            'tables.acl_roles_data' => 'foro3_acl_roles_data',
            'tables.acl_users' => 'foro3_acl_users',
            'tables.attachments' => 'foro3_attachments',
            'tables.auth_provider_oauth_token_storage' => 'foro3_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'foro3_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'foro3_oauth_accounts',
            'tables.banlist' => 'foro3_banlist',
            'tables.bbcodes' => 'foro3_bbcodes',
            'tables.bookmarks' => 'foro3_bookmarks',
            'tables.bots' => 'foro3_bots',
            'tables.captcha_qa_questions' => 'foro3_captcha_questions',
            'tables.captcha_qa_answers' => 'foro3_captcha_answers',
            'tables.captcha_qa_confirm' => 'foro3_qa_confirm',
            'tables.config' => 'foro3_config',
            'tables.config_text' => 'foro3_config_text',
            'tables.confirm' => 'foro3_confirm',
            'tables.disallow' => 'foro3_disallow',
            'tables.drafts' => 'foro3_drafts',
            'tables.ext' => 'foro3_ext',
            'tables.extensions' => 'foro3_extensions',
            'tables.extension_groups' => 'foro3_extension_groups',
            'tables.forums' => 'foro3_forums',
            'tables.forums_access' => 'foro3_forums_access',
            'tables.forums_track' => 'foro3_forums_track',
            'tables.forums_watch' => 'foro3_forums_watch',
            'tables.groups' => 'foro3_groups',
            'tables.icons' => 'foro3_icons',
            'tables.lang' => 'foro3_lang',
            'tables.log' => 'foro3_log',
            'tables.login_attempts' => 'foro3_login_attempts',
            'tables.migrations' => 'foro3_migrations',
            'tables.moderator_cache' => 'foro3_moderator_cache',
            'tables.modules' => 'foro3_modules',
            'tables.notification_types' => 'foro3_notification_types',
            'tables.notifications' => 'foro3_notifications',
            'tables.poll_options' => 'foro3_poll_options',
            'tables.poll_votes' => 'foro3_poll_votes',
            'tables.posts' => 'foro3_posts',
            'tables.privmsgs' => 'foro3_privmsgs',
            'tables.privmsgs_folder' => 'foro3_privmsgs_folder',
            'tables.privmsgs_rules' => 'foro3_privmsgs_rules',
            'tables.privmsgs_to' => 'foro3_privmsgs_to',
            'tables.profile_fields' => 'foro3_profile_fields',
            'tables.profile_fields_data' => 'foro3_profile_fields_data',
            'tables.profile_fields_options_language' => 'foro3_profile_fields_lang',
            'tables.profile_fields_language' => 'foro3_profile_lang',
            'tables.ranks' => 'foro3_ranks',
            'tables.reports' => 'foro3_reports',
            'tables.reports_reasons' => 'foro3_reports_reasons',
            'tables.search_results' => 'foro3_search_results',
            'tables.search_wordlist' => 'foro3_search_wordlist',
            'tables.search_wordmatch' => 'foro3_search_wordmatch',
            'tables.sessions' => 'foro3_sessions',
            'tables.sessions_keys' => 'foro3_sessions_keys',
            'tables.sitelist' => 'foro3_sitelist',
            'tables.smilies' => 'foro3_smilies',
            'tables.sphinx' => 'foro3_sphinx',
            'tables.styles' => 'foro3_styles',
            'tables.styles_template' => 'foro3_styles_template',
            'tables.styles_template_data' => 'foro3_styles_template_data',
            'tables.styles_theme' => 'foro3_styles_theme',
            'tables.styles_imageset' => 'foro3_styles_imageset',
            'tables.styles_imageset_data' => 'foro3_styles_imageset_data',
            'tables.teampage' => 'foro3_teampage',
            'tables.topics' => 'foro3_topics',
            'tables.topics_posted' => 'foro3_topics_posted',
            'tables.topics_track' => 'foro3_topics_track',
            'tables.topics_watch' => 'foro3_topics_watch',
            'tables.user_group' => 'foro3_user_group',
            'tables.user_notifications' => 'foro3_user_notifications',
            'tables.users' => 'foro3_users',
            'tables.warnings' => 'foro3_warnings',
            'tables.words' => 'foro3_words',
            'tables.zebra' => 'foro3_zebra',
...
class phpbbtemplatetwiglexer_00000000716874ea000000007010d2a4 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder684859246762e289001034 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6848592467632090828694 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties684859246761a001541428 = array(
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, 'set_environment', array('env' => $env), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        return $this->valueHolder684859246762e289001034->set_environment($env);
    }
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        return $this->valueHolder684859246762e289001034->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        return $this->valueHolder684859246762e289001034->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer6848592467632090828694 = $initializer;
    }
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__get', array('name' => $name), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        if (isset(self::$publicProperties684859246761a001541428[$name])) {
            return $this->valueHolder684859246762e289001034->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder684859246762e289001034;
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__isset', array('name' => $name), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__unset', array('name' => $name), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;
    ...
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__clone', array(), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        $this->valueHolder684859246762e289001034 = clone $this->valueHolder684859246762e289001034;
    }

    public function __sleep()
    {
        $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, '__sleep', array(), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;

        return array('valueHolder684859246762e289001034');
    }
    ...
    {
        return $this->initializer6848592467632090828694;
    }
    ...
    {
        return $this->initializer6848592467632090828694 && ($this->initializer6848592467632090828694->__invoke($valueHolder684859246762e289001034, $this, 'initializeProxy', array(), $this->initializer6848592467632090828694) || 1) && $this->valueHolder684859246762e289001034 = $valueHolder684859246762e289001034;
    }
    ...
    {
        return null !== $this->valueHolder684859246762e289001034;
    }
    ...
    {
        return $this->valueHolder684859246762e289001034;
    }
