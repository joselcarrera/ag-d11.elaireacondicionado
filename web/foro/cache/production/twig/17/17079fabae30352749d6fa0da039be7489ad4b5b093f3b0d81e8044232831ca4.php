...
/* forumlist_body.html */
class __TwigTemplate_4906101e0e3c4534ab8305da292a79e659eb5a57c804e2d3d3e237335ddce2ca extends \Twig\Template
{
...
\t\t\t\t\t\t\t";
                    ...
                    if ($this->getAttribute($context["forumrow"], "U_UNAPPROVED_TOPICS", [])) {
                        ...
                        echo "\" title=\"";
                        echo ($context["TOPICS_UNAPPROVED"] ?? null);
                        echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"icon fa-question-circle fa-fw icon-blue\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                        // line 85
                        echo ($context["TOPICS_UNAPPROVED"] ?? null);
                        echo "</span>
\t\t\t\t\t\t\t\t</a>
...
$context["forumrow"], "U_UNAPPROVED_POSTS", [])) {
                        ...
                        echo "\" title=\"";
                        echo ($context["POSTS_UNAPPROVED_FORUM"] ?? null);
                        echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"icon fa-question-circle fa-fw icon-blue\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                        // line 89
                        echo ($context["POSTS_UNAPPROVED_FORUM"] ?? null);
...
\t\t\t\t\t\t\t\t";
                        ...
                        if ( !($context["S_IS_BOT"] ?? null)) {
                            ...
                            echo "\">
\t\t\t\t\t\t\t\t\t\t<i class=\"icon fa-arrow-right fa-fw icon-lightgray icon-md\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                            // line 101
                            echo ($context["VIEW_LATEST_POST"] ?? null);
                            echo "</span>
\t\t\t\t\t\t\t\t\t</a>
