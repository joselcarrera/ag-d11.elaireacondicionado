...
function elaireacondicionado_base64url_encode($data) {
    return rtrim(strtr(base64_encode($data), '+/', '-_'), '=');
}
    
function elaireacondicionado_base64url_decode($data) {
...
function page_header($page_title = '', $display_online_list = false, $item_id = 0, $item = 'forum', $send_headers = true)
{
	...
	*/
    ...
    require_once($phpbb_root_path . 'mobile-detect/Mobile_Detect.php');
	...
	$template->assign_vars(array(
        'PRENSA_OF_LINK'                   => elaireacondicionado_base64url_encode("/prensa"),
        'MAPA_WEB_OF_LINK'                 => elaireacondicionado_base64url_encode("/mapa-web"),
        'POLITICA_COOKIES_OF_LINK'         => elaireacondicionado_base64url_encode("/privacidad-cookies"),
        'CONTACTO_OF_LINK'         => elaireacondicionado_base64url_encode("/contacto"),
        'TWITTER_OF_LINK'         => elaireacondicionado_base64url_encode("https://twitter.com/el_aire"),
        'FACEBOOK_OF_LINK'         => elaireacondicionado_base64url_encode("https://www.facebook.com/elaireacondicionadocom/"),
        'IS_MOBILE'                     => $is_mobile,
