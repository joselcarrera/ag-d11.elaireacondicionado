...
elaire_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of elaire_radix theme and run the following commands:
`nvm use`
...
`drush en elaire_radix -y`
`drush config-set system.theme default elaire_radix -y`
